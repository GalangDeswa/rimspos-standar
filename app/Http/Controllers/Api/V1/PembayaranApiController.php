    ...
    public function pembayaran(Request $request){
        ...
        try {
            ...
            $validator = Validator::make($request->all(),
                        ...
                        'bayar' => 'required_if:metode_bayar,==,1,2|nullable|integer',
                        
                        'metode_bayar' => 'required|int',

                         'id_pelanggan' => 'required_if:metode_bayar,==,3|nullable|integer',
                    ...
                    if(count($getkeranjang) > 0){
                        ...
                        $addpenjualan->tgl_penjualan = date("Y-m-d H:i:s");
                         ...
                         if($request->metode_bayar){
                              ...
                              $addpenjualan->metode_bayar = 1;

                         }


                         if($request->metode_bayar == 1){
                        ...
                        if($request->metode_bayar == 3){
                           ...
                           $addpenjualan->id_pelanggan = $request->id_pelanggan;
                          ...
                          // $cektoko = Toko::where('id',$request->id_toko) ->first();
                                ...
                                $addpenjualan->id_hutang = $addhutang->id;

                                $addhutang->id_toko = $request->id_toko;
                                $addhutang->id_pelanggan = $request->id_pelanggan;
                                $addhutang->hutang = $sumkeranjang->total;
                                $addhutang->tgl_hutang = date("Y-m-d H:i:s");
                                $addhutang->status = 2;
                                $addhutang->save();
                                $idhutang = $addhutang->id;
                                $addpenjualan->id_hutang = $idhutang;
                        ...
                        foreach ($getkeranjang as $keranjang) {
                            ...
                            $harga_m = Produk::where('id',$keranjang->id_produk)->first();
                          ...
                          //  echo($harga_m->id);
                           ...
                           $dtlpenjualan->id_jenis_stock    = $keranjang->id_jenis_stock;
                            ...
                            $dtlpenjualan->harga_modal       = $harga_m->harga_modal;
